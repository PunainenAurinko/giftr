		...
		if(app.version == ''){
			...
			tonk0006_giftr.db.changeVersion('', app.version,
					function(trans){
						...
						trans.executeSql('INSERT INTO people(person_name) VALUES(?)', ["Vlad"], 
										function(tx, rs){
			...
			console.log('Version:' + tonk0006_giftr.version)   ;
		}
	},
	fillpeople: function(){
